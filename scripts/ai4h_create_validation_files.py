...
from paperext.structured_output.ai4hcat.model_v1 import Category, Response, SubCategory


if __name__ == "__main__":
    paperoni = Path(CFG.dir.data / "paperoni-2022-01-01-2023-01-01-PR_2025-02-28.json")
    _file = Path("ai4h_cat - validation_01.csv")
    ...
    for p in json.loads(paperoni.read_text()):
        ...
        cat, subcat = data[paper._paper_id]
